<html>
    ...
    <body>
        ...
        <main>
            ...
            <section class="info">
                <article class="post">
                    <img class="laptop" src="https://learn.algoritmika.org/uploads/2021/03/tag-151102.svg">
                ...
                <article class="post">
                    <h2>Телефон мечты</h2>
                    <img class="post-img" src="https://wylsa.com/wp-content/uploads/2019/12/Samsung-Galaxy-A51-00.jpg" width="400px" height="300px"/>
                    <p class="post-text">Samsung Galaxy A51</p>
                    <a class="article-but" href="">Подробнее</a>
                </article>
                <article class="post">
                    <img class="laptop" src="https://learn.algoritmika.org/uploads/2021/03/tag-151102.svg">
            ...
            <aside class="id">
            <p><b>Подпишись- получи промокод!</b></p>
            <a class="social" href=""><img src="/uploads/2021/02/icon-set-1142000_1280%201_0_1613586391.png" width="30px" height="30px"></a>
            <a class="social" href=""><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Instagram_icon.png/2048px-Instagram_icon.png" width="30px" height="30px"></a>
            <a class="social" href=""><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/Telegram_2019_Logo.svg/512px-Telegram_2019_Logo.svg.png" width="30px" height="30px"></a>
            </aside>
